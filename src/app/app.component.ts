...
Data = [
  {
    ...
    duration: "month",
    details:[
      { title : "Single User",isAvailable : true,boldLetter : false},
      { title : "5GB Storage",isAvailable : true,boldLetter : false},
      { title : "Unlimitted Public Projects",isAvailable : true,boldLetter : false},
      { title : "Community Access",isAvailable : true,boldLetter : false},
      { title : "Unlimitted Private Projects",isAvailable : false,boldLetter : false},
  ...
  },
  {
    ...
    details:[
      ...
      { title : "Unlimitted Public Projects",isAvailable : true,boldLetter : false },
      { title : "Community Access",isAvailable : true,boldLetter : false },
      { title : "Unlimitted Private Projects",isAvailable : true,boldLetter : false },
  ...
  },
  {
    ...
    duration: "month",
    details:[
      { title : "Unlimitted Users",isAvailable : true,boldLetter : true },
      { title : "150GB Storage",isAvailable : true,boldLetter : false },
      { title : "Unlimitted Public Projects",isAvailable : true,boldLetter : false },
      { title : "Community Access",isAvailable : true,boldLetter : false },
      { title : "Unlimitted Private Projects", isAvailable : true, boldLetter : false },
      { title : "Dedicated Phone Support",isAvailable : true,boldLetter : false },
      { title : "Unlimitted Free SubDomain",isAvailable : true,boldLetter : true },
      { title : "Monthly Status Reports", isAvailable : true,boldLetter : false }
    ]
  }
];
